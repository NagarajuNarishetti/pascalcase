        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link href="#about" className="inline-flex items-center justify-center rounded-md border border-border-default px-5 py-3 text-sm font-medium hover:bg-overlay-1">Learn More</Link>
